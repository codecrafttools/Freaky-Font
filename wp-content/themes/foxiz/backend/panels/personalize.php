		...
		return [
			...
			'fields'     => [
				...
				[
					...
					'description' => esc_html__( 'This is a global option. Disabling it will disable all bookmark and follow AJAX requests and prevent writing data to the database.', 'foxiz' ),
					'default'     => true,
				],
				[
...
if ( ! function_exists( 'foxiz_register_options_user_history' ) ) {
	function foxiz_register_options_user_history() {
		...
		return [
			'title'      => esc_html__( 'Reading History', 'foxiz' ),
			'id'         => 'foxiz_config_section_user_history',
			'desc'       => esc_html__( 'Customize the user reading history feature.', 'foxiz' ),
			...
			'fields'     => [
				...
				[
					...
					'type'     => 'switch',
					'title'    => esc_html__( 'Reading History', 'foxiz' ),
					'subtitle' => esc_html__( 'Enable or disable the user reading history feature.', 'foxiz' ),
					'default'  => false,
				],
				[
				...
				[
					...
					'default'  => esc_html__( 'No Reading History', 'foxiz' ),
				],
				[
