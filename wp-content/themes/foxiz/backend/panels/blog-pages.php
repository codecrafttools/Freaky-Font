		...
		return [
			...
			'fields'     => [
				...
				[
					...
					'subtitle' => esc_html__( 'Enable or disable archive and tag title prefix.', 'foxiz' ),
					'type'     => 'select',
					'options'  => [
						'0' => esc_html__( '- Default -', 'foxiz' ),
				...
				[
					...
					'title'       => esc_html__( 'Tag - Global WP Query Template Shortcode', 'foxiz' ),
		...
		return [
			...
			'fields'     => [
				...
				[
					...
					'subtitle' => esc_html__( 'this setting will remove all other search result except post and podcast (if enable).', 'foxiz' ),
					'type'     => 'switch',
					'default'  => false,
				],
				[
					'id'       => $prefix . 'exclude_page',
					'title'    => esc_html__( 'Exclude Pages', 'foxiz' ),
					'subtitle' => esc_html__( 'Exclude pages in the search results.', 'foxiz' ),
					'type'     => 'switch',
					'default'  => true,
				],
				[
					'id'       => $prefix . 'exclude_attachment',
					'title'    => esc_html__( 'Exclude Attachments', 'foxiz' ),
					'subtitle' => esc_html__( 'Exclude attachment in the search results.', 'foxiz' ),
					'type'     => 'switch',
					'default'  => true,
				],
				[
